...
public class LDKCoinSelector : CoinSelectionSourceInterface
{
    ...
    public LDKCoinSelector(WalletService walletService, Network network, CurrentWalletService currentWalletService)
    {
        ...
        int target_feerate_sat_per_1000_weight)
    {
        ...
        var tx = _walletService.CreateTransaction(
    ...
    public Result_TransactionNoneZ sign_tx(byte[] tx)
    {
        ...
        tx1 = _walletService.SignTransaction(_currentWalletService.CurrentWallet,tx1).GetAwaiter().GetResult();
