...
public static class ChannelExtensions
{
    ...
    public static IDisposable SubscribeToEventWithChannelQueue<TEvent>(Action<EventHandler<TEvent>> add, Action<EventHandler<TEvent>> remove, Func<TEvent, CancellationToken,Task> processor,
        CancellationToken cancellationToken)
    {
